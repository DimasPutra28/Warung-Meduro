                                        ...
                                        <div class="modal-body">
                                            <form action="/adminbrg/store" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <label for="exampleFormControlTextarea1" class="form-label">Status
                                                            Barang</label>
                                                        <select name="status" id="status">
                                                            <option value="">Status Barang</option>
                                                            <option value="jual">Dijual</option>
                                                            <option value="tidak">Tidak Dijual</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModaleditbr">
                                                        Edit
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="modal fade" id="exampleModaleditbr" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/adminbarang/{{ $barang->id }}"
